...
import { addProductoItem } from '../../../../redux/productos/actions';
...
const AddNewModal = ({
  ...
  const loading = useSelector((state) => state.productos.modalAddLoading);
    ...
    setTimeout(() => {
      if (!canAdd) {
        ...
        const producto = {
          ...
          refLocalComercial: refLocalComercial.id,
          refCategoria,
        };
            ...
            {loading ? (
              ...
              <Form className="av-tooltip tooltip-label-bottom">
                <ModalHeader toggle={toggleModal}>
                  <IntlMessages id="producto.anadirNuevoProducto" />
                </ModalHeader>
                <ModalBody>
                  <Row>
