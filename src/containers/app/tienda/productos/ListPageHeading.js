      ...
      <Colxx xxs="12">
        <div className="mb-2">
          ...
          <div className="text-zero top-right-button-container">
            <Button
              color="primary"
              className="top-right-button simple-icon-arrow-left
              "
              onClick={() => history.push('/app/tienda/categorias')}
            />
            <Button
              color="primary"
              size="lg"
              ...
              onClick={() => toggleModal()}
            >
              <IntlMessages id="producto.add" />
            </Button>
            <ButtonDropdown
              isOpen={dropdownSplitOpen}
              toggle={() => setDropdownSplitOpen(!dropdownSplitOpen)}
            >
              <div className="btn btn-primary btn-lg pl-4 pr-0 check-button check-all ml-1 ">
                <CustomInput
